...
public class ContaBancariaRest 
	...
	public @ResponseBody ResponseEntity<List<Transacoes>> consultarExtrato(
	        @RequestParam String agencia, 
	        @RequestParam String numeroConta) {
	    List<Transacoes> extrato = contaBancariaService.consultarTransacoes(agencia, numeroConta);
