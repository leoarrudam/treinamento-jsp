...
public class ClienteService extends GenericCrudService<Cliente, Long, ClienteRepository> {
	...
	public List<ClienteDTO> buscarClientePorNome(String nome) {
		...
		List<Cliente> listaClienteEntity = clienteRepository.findByNomeJpql(nome);
	...
	/**
	 * Retorna os detalhes de todos os clientes com saldo
	 * 
	 * @return Elemento listaCliente(cliente*)
	 *         Elemento cliente (nome, agencia, conta, saldo)
	 */
	...
	public Elemento listarClientesComSaldo() {
		...
		for (Cliente cliente : listaClientes) {
			...
			for (ContaBancaria conta : contas) {
				...
				elementoCliente.incluirFilho("saldo", String.valueOf(conta.getSaldo()));
			}
		}
